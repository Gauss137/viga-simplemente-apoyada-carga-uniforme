      ...
      <footer className="w-full bg-white py-4 mt-8 border-t border-gray-100">
        <div className="max-w-4xl mx-auto px-6 text-center text-sm text-gray-600">
          ...
          <div className="flex justify-center items-center space-x-4 mt-2">
            <a href="#" className="bg-[#f1d475] text-white px-3 py-1 rounded-full text-xs border border-gray-800 hover:bg-[#e6c760] transition">Botón Cafecito</a>
            <a href="#" className="bg-[#f1d475] text-white px-3 py-1 rounded-full text-xs border border-gray-800 hover:bg-[#e6c760] transition">Botón PayPal</a>
          </div>
